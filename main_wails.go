...
func startBackend(host string, port int) (*backendRuntime, error) {
	...
	if clientID != "" && clientSecret != "" {
		ssoConfig = &auth.SSOConfig{
			...
			Scopes: "esi-location.read_location.v1 esi-skills.read_skills.v1 esi-skills.read_skillqueue.v1 esi-wallet.read_character_wallet.v1 esi-assets.read_assets.v1 esi-assets.read_corporation_assets.v1 esi-characters.read_blueprints.v1 esi-markets.structure_markets.v1 esi-universe.read_structures.v1 esi-markets.read_character_orders.v1" +
